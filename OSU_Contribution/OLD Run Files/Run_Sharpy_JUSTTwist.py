...
beam_save_file = 'Final_twisted.xlsx'
min_thick = .0001
max_thick = .003
low_twist = -10
high_twist = 10
...
x_loc_twist = np.linspace(0, 1, 5)

global ei
ei = [1.22564272, 0.68228292, 0.28230522, 0.28230522, 0.28230522, 0.28230523]
guess = [1, 1, 2, 4]
...
def beam_opt(guess):
    ...
    # if divergence in structural solver
    if data.structure.div_flag.value == 1:
